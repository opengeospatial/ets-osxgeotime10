...
public class TestNGController implements TestSuiteController {
     ...
     *
     * @param outputDir The directory to write test results to. It will be
    ...
    public TestNGController(String outputDir) {
        ...
        TestSuiteLogger.log(Level.CONFIG, "Using TestNG config at " + tngSuite);
        // setting the third argument to 'true' enables the default listeners
        this.executor = new TestNGExecutor(tngSuite.toString(), outputDir, false);
    }
