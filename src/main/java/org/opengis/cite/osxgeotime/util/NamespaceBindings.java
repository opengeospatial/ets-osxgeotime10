...
import org.opengis.cite.osxgeotime.Namespaces;
...
public class NamespaceBindings implements NamespaceContext {
     ...
     *
     * <ul>
     * <li>ows: {@value org.opengis.cite.osxgeotime.Namespaces#OWS}</li>
     * <li>xlink: {@value org.opengis.cite.osxgeotime.Namespaces#XLINK}</li>
     * <li>gml: {@value org.opengis.cite.osxgeotime.Namespaces#GML}</li>
     * <li>os: {@value org.opengis.cite.osxgeotime.Namespaces#OS}</li>
     * <li>geo: {@value org.opengis.cite.osxgeotime.Namespaces#OSGEO}</li>
     * <li>time: {@value org.opengis.cite.osxgeotime.Namespaces#OSTIME}</li>
     * <li>georss: {@value org.opengis.cite.osxgeotime.Namespaces#GEORSS}</li>
     * <li>dc: {@value org.opengis.cite.osxgeotime.Namespaces#DC}</li>
     * </ul>
     *
    ...
    public static NamespaceBindings withStandardBindings() {
        ...
        nsBindings.addNamespaceBinding(Namespaces.OS, "os");
        nsBindings.addNamespaceBinding(Namespaces.OSGEO, "geo");
        nsBindings.addNamespaceBinding(Namespaces.OSTIME, "time");
        nsBindings.addNamespaceBinding(Namespaces.GEORSS, "georss");
        nsBindings.addNamespaceBinding(Namespaces.DC, "dc");
        return nsBindings;
    }
